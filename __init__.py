...
from .bk_maya import global_vars
...
if "bpy" in locals():
    ...
    from .bk_maya import addon_updater_ops
    from .bk_maya import timer
    from .bk_maya import append_link
    from .bk_maya.asset_bar import asset_bar_op
    from .bk_maya.asset_bar import asset_drag_op
    from .bk_maya import asset_inspector
    from .bk_maya import autothumb
    from .bk_maya import bg_blender
    from .bk_maya import bkit_oauth
    from .bk_maya import categories
    from .bk_maya import colors
    from .bk_maya import client_lib
    from .bk_maya import client_tasks
    from .bk_maya import client_thread
    from .bk_maya import disclaimer_op
    from .bk_maya import warning_dialog
    from .bk_maya import download
    from .bk_maya import icons
    from .bk_maya import image_utils
    from .bk_maya import overrides

    if bpy.app.version >= (4, 2, 0):
        from .bk_maya import override_extension_draw
    from .bk_maya import paths
    from .bk_maya import ratings
    from .bk_maya import ratings_utils
    from .bk_maya import comments_utils
    from .bk_maya import resolutions
    from .bk_maya import search
    from .bk_maya import tasks_queue
    from .bk_maya import ui
    from .bk_maya import ui_bgl
    from .bk_maya import ui_panels
    from .bk_maya import keymap_utils
    from .bk_maya import upload
    from .bk_maya import upload_bg
    from .bk_maya import utils
    from .bk_maya import persistent_preferences
    from .bk_maya import reports

    from .bk_maya.bl_ui_widgets import bl_ui_widget
    from .bk_maya.bl_ui_widgets import bl_ui_label
    from .bk_maya.bl_ui_widgets import bl_ui_button
    from .bk_maya.bl_ui_widgets import bl_ui_image

    # from .bl_ui_widgets import bl_ui_checkbox
    # from .bl_ui_widgets import bl_ui_slider
    # from .bl_ui_widgets import bl_ui_up_down
    from .bk_maya.bl_ui_widgets import bl_ui_draw_op
    from .bk_maya.bl_ui_widgets import bl_ui_drag_panel
